...
GOTCH_PATH="$GOPATH/pkg/mod/github.com/theomarzaki/gotch@$GOTCH_VERSION"
...
cd $GOTCH_TEST_DIR
go mod init "github.com/theomarzaki/gotch-test"
go get -d "github.com/theomarzaki/gotch@$GOTCH_VERSION" 
